...
export const translations: Record<Language, Translations> = {
  ...
  th: {
    ...
    home: {
      ...
      studentVoiceDesc: 'รับฟังจากนักบินที่เรียนกับเราและประสบความสำเร็จในวงการการบิน',
      noMessages: 'ยังไม่มีข้อความ',
      whyChooseUsEyebrow: 'ทำไมต้องเรา',
      whyChooseUsTitle: 'ออกแบบมาเพื่อนักเรียนนักบินโดยเฉพาะ',
      supportiveLearning: 'บรรยากาศเรียนรู้ที่เป็นกันเอง',
      supportiveLearningDesc: 'เพื่อนร่วมคอร์สที่เป็นมิตร พร้อมช่วยตอบทุกคำถามที่คุณสงสัย',
      ...
      getInTouchTitle: 'พร้อมเริ่มต้นเส้นทางของคุณหรือยัง?',
      getInTouchDesc: 'มีคำถามเรื่องหลักสูตรหรือการสมัครเรียนไหม? ทีมผู้สอนผู้มากประสบการณ์พร้อมให้คำปรึกษาผ่าน Line Official',
